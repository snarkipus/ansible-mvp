...
- Add Python project tooling with `uv`, `ruff`, and `basedpyright` so implementation and verification use explicit, repeatable commands.
...
- Uses local tooling dependencies documented for the MVP: Git, Make, Ansible, Python 3.11+, Perl, `uv`, `ruff`, `basedpyright`, PyYAML, pytest, openpyxl, and python-pptx.
